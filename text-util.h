...
VIX_INTERNAL Filerange text_range_union(Filerange, Filerange);
/* get intersection of two ranges */
VIX_INTERNAL Filerange text_range_intersect(Filerange, Filerange);
/* create new range [min(a,b), max(a,b)] */
VIX_INTERNAL Filerange text_range_new(size_t a, size_t b);
/* test whether two ranges are equal */
VIX_INTERNAL bool text_range_equal(Filerange, Filerange);
/* test whether two ranges overlap */
VIX_INTERNAL bool text_range_overlap(Filerange, Filerange);
/* test whether a given position is within a certain range */
VIX_INTERNAL bool text_range_contains(Filerange, size_t pos);
