Tests for vix specific editing features
---------------------------------------

The basic idea is to feed keyboard input to `vix` and compare the
...
directories, feeds the keys to `vix` and compares the produces output.
