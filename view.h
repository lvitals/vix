 ...
 * @{
 */
VIX_INTERNAL bool view_init(struct Win*, Text*);
VIX_INTERNAL void view_free(View*);
VIX_INTERNAL void view_reload(View*, Text*);
/**
 * @}
 ...
 */
VIX_INTERNAL bool view_coord_get(View *view, size_t pos, Line **line, int *row, int *col);
/** Get position at the start of the ``n``-th window line, counting from 1. */
VIX_INTERNAL size_t view_screenline_goto(View*, int n);
VIX_INTERNAL size_t view_slide_up(View*, int lines);
VIX_INTERNAL size_t view_slide_down(View*, int lines);
VIX_INTERNAL size_t view_scroll_up(View*, int lines);
VIX_INTERNAL size_t view_scroll_down(View*, int lines);
VIX_INTERNAL size_t view_scroll_page_up(View*);
VIX_INTERNAL size_t view_scroll_page_down(View*);
VIX_INTERNAL size_t view_scroll_halfpage_up(View*);
VIX_INTERNAL size_t view_scroll_halfpage_down(View*);
VIX_INTERNAL void   view_redraw_top(View*);
VIX_INTERNAL void   view_redraw_center(View*);
VIX_INTERNAL void   view_redraw_bottom(View*);
/**
 * @}
 * @defgroup view_size View Sizing
 * @{
 */
VIX_INTERNAL bool view_resize(View*, int width, int height);
/**
 * @}
 * @defgroup view_draw View Drawing
 * @{
 */
VIX_INTERNAL void view_draw(View*);
VIX_INTERNAL bool view_update(View*);
 ...
 * @endrst
 */
VIX_INTERNAL Selection *view_selections_new(View*, size_t pos);
/**
 ...
 * @endrst
 */
VIX_INTERNAL Selection *view_selections_new_force(View*, size_t pos);
/**
 ...
 * @endrst
 */
VIX_INTERNAL bool view_selections_dispose(Selection*);
/**
 ...
 * will be disposed.
 */
VIX_INTERNAL bool view_selections_dispose_force(Selection*);
/**
 ...
 */
VIX_INTERNAL Selection *view_selection_disposed(View*);
/** Dispose all but the primary selection. */
VIX_INTERNAL void view_selections_dispose_all(View*);
/** Dispose all invalid and merge all overlapping selections. */
VIX_INTERNAL void view_selections_normalize(View*);
/**
 ...
 */
VIX_INTERNAL void view_selections_set_all(View *view, FilerangeList ranges, bool anchored);
/** Get list containing the ``Filerange``s for each selection. */
VIX_INTERNAL FilerangeList view_selections_get_all(Vix*, View*);
/**
 * @}
 * @defgroup view_navigate Selection Navigation
 * @{
 */
VIX_INTERNAL Selection *view_selections_primary_get(View*);
VIX_INTERNAL void view_selections_primary_set(Selection*);
/** Get first selection. */
VIX_INTERNAL Selection *view_selections(View*);
/** Get immediate predecessor of selection. */
VIX_INTERNAL Selection *view_selections_prev(Selection*);
/** Get immediate successor of selection. */
VIX_INTERNAL Selection *view_selections_next(Selection*);
/**
 * Get selection index.
 * @rst
 ...
 */
VIX_INTERNAL Selection *view_selections_column(View *view, int column);
/**
 * Get the next `column`-th selection on a line.
 * @param sel The selection to manipulate.
 * @param column The zero based column index.
 */
VIX_INTERNAL Selection *view_selections_column_next(Selection *sel, int column);
/**
 * @}
 ...
 * @endrst
 */
VIX_INTERNAL void view_selection_clear(Selection*);
/** Reduce *all* currently active selections. */
VIX_INTERNAL void view_selections_clear_all(View*);
/**
 ...
 * @endrst
 */
VIX_INTERNAL void view_selections_flip(Selection*);
/**
 * @}
...
VIX_INTERNAL size_t view_cursors_pos(Selection*);
/** Get 1-based line number of selection cursor. */
VIX_INTERNAL size_t view_cursors_line(Selection*);
/**
 ...
 * @endrst
 */
VIX_INTERNAL size_t view_cursors_col(Selection*);
/**
 * @}
 ...
 * @endrst
 */
VIX_INTERNAL void view_cursors_to(Selection*, size_t pos);
/**
 ...
 * @endrst
 */
VIX_INTERNAL void view_cursors_scroll_to(Selection*, size_t pos);
/**
 ...
 * @endrst
 */
VIX_INTERNAL void view_cursors_place(Selection *s, size_t line, size_t col);
/**
 ...
 * @endrst
 */
VIX_INTERNAL int view_cursors_cell_set(Selection*, int cell);
/**
 * @}
 * @defgroup view_motions View Motions
 * @{
 */
VIX_INTERNAL size_t view_line_down(Selection*);
VIX_INTERNAL size_t view_line_up(Selection*);
VIX_INTERNAL size_t view_screenline_down(Selection*);
VIX_INTERNAL size_t view_screenline_up(Selection*);
VIX_INTERNAL size_t view_screenline_begin(Selection*);
VIX_INTERNAL size_t view_screenline_middle(Selection*);
VIX_INTERNAL size_t view_screenline_end(Selection*);
/**
 * @}
...
VIX_INTERNAL size_t view_cursor_get(View*);
/**
 * @}
 ...
 * @{
 */
VIX_INTERNAL void win_options_set(struct Win *, enum UiOption);
VIX_INTERNAL bool view_breakat_set(View*, const char *breakat);

/** Set how many spaces are used to display a tab `\t` character. */
VIX_INTERNAL void view_tabwidth_set(View*, int tabwidth);
/** Apply a style to a text range. */
VIX_INTERNAL void win_style(struct Win*, enum UiStyle, size_t start, size_t end, bool keep_non_default);
