 ...
 *
 * @rst
 * .. note:: Equivalent to ``text_load_method(vix, filename, TEXT_LOAD_AUTO)``.
 * @endrst
 */
VIX_INTERNAL Text *text_load(Vix *vix, const char *filename);
/**
 * Create a text instance populated with the given file content.
 *
 ...
 * @endrst
 */
VIX_INTERNAL Text *text_load_method(Vix *vix, const char *filename, enum TextLoadMethod method);
VIX_INTERNAL Text *text_loadat_method(Vix *vix, int dirfd, const char *filename, enum TextLoadMethod);
/** Release all resources associated with this text instance. */
VIX_INTERNAL void text_free(Text*);
/**
 * @}
...
VIX_INTERNAL size_t text_size(const Text*);
/**
 ...
 */
VIX_INTERNAL struct stat text_stat(const Text*);
/** Query whether the text contains any unsaved modifications. */
VIX_INTERNAL bool text_modified(const Text*);
/**
 * @}
 ...
 */
VIX_INTERNAL bool text_insert(Vix *vix, Text *txt, size_t pos, const char *data, size_t len);
/**
 ...
 */
VIX_INTERNAL void text_snapshot(Text*);
/**
 ...
 */
VIX_INTERNAL size_t text_undo(Text*);
/**
 ...
 */
VIX_INTERNAL size_t text_redo(Text*);
VIX_INTERNAL size_t text_earlier(Text*);
VIX_INTERNAL size_t text_later(Text*);
/**
 * Restore the text to the state closest to the time given
 */
VIX_INTERNAL size_t text_restore(Text*, time_t);
/**
 ...
 * @endrst
 */
VIX_INTERNAL time_t text_state(const Text*);
/**
 * @}
 ...
 * @endrst
 */
VIX_INTERNAL bool text_byte_get(const Text *txt, size_t pos, char *byte);
/**
 ...
 * @endrst
 */
VIX_INTERNAL size_t text_bytes_get(const Text *txt, size_t pos, size_t len, char *buf);
/**
 ...
 * @endrst
 */
VIX_INTERNAL char *text_bytes_alloc0(const Text *txt, size_t pos, size_t len);
/**
 * @}
 * @defgroup iterator Text Iterators
 * @{
 */
VIX_INTERNAL Iterator text_iterator_get(const Text*, size_t pos);
VIX_INTERNAL bool text_iterator_init(const Text*, Iterator*, size_t pos);
VIX_INTERNAL const Text *text_iterator_text(const Iterator*);
VIX_INTERNAL bool text_iterator_valid(const Iterator*);
VIX_INTERNAL bool text_iterator_has_next(const Iterator*);
VIX_INTERNAL bool text_iterator_has_prev(const Iterator*);
VIX_INTERNAL bool text_iterator_next(Iterator*);
VIX_INTERNAL bool text_iterator_prev(Iterator*);
/**
 * @}
 * @defgroup iterator_byte Byte Iterators
 * @{
 */
VIX_INTERNAL bool text_iterator_byte_get(const Iterator*, char *b);
VIX_INTERNAL bool text_iterator_byte_prev(Iterator*, char *b);
VIX_INTERNAL bool text_iterator_byte_next(Iterator*, char *b);
VIX_INTERNAL bool text_iterator_byte_find_prev(Iterator*, char b);
VIX_INTERNAL bool text_iterator_byte_find_next(Iterator*, char b);
/**
 * @}
 * @defgroup iterator_code Codepoint Iterators
 * @{
 */
VIX_INTERNAL bool text_iterator_codepoint_next(Iterator *it, char *c);
VIX_INTERNAL bool text_iterator_codepoint_prev(Iterator *it, char *c);
/**
 * @}
 * @defgroup iterator_char Character Iterators
 * @{
 */
VIX_INTERNAL bool text_iterator_char_next(Iterator*, char *c);
VIX_INTERNAL bool text_iterator_char_prev(Iterator*, char *c);
/**
 * @}
 * @defgroup mark Marks
 * @{
 ...
 */
VIX_INTERNAL Mark text_mark_set(Text *txt, size_t pos);
/**
 * Lookup a mark.
 * @param txt The text instance to modify.
 ...
 */
VIX_INTERNAL size_t text_mark_get(const Text *txt, Mark mark);
/**
 * @}
 ...
 */
VIX_INTERNAL void text_mark_current_revision(Text*);
 ...
 * @endrst
 */
VIX_INTERNAL bool text_save_begin(TextSave*);
/**
 * Write file range.
 ...
 * @endrst
 */
VIX_INTERNAL bool text_save_commit(TextSave*);
/**
 ...
 * @endrst
 */
VIX_INTERNAL void text_save_cancel(TextSave*);
/**
 ...
 * this text instance.
 */
VIX_INTERNAL bool text_mmaped(const Text*, const char *ptr);

/**
 * Write complete buffer to file descriptor.
 * @return The number of bytes written or ``-1`` in case of an error.
 */
VIX_INTERNAL ssize_t write_all(int fd, const char *buf, size_t count);
/** @} */
