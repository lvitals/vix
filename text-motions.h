...
VIX_INTERNAL size_t text_char_next(Text*, size_t pos);
VIX_INTERNAL size_t text_char_prev(Text*, size_t pos);

VIX_INTERNAL size_t text_codepoint_next(Text*, size_t pos);
VIX_INTERNAL size_t text_codepoint_prev(Text*, size_t pos);
 ...
 * original position */
VIX_INTERNAL size_t text_find_next(Text*, size_t pos, const char *s);
VIX_INTERNAL size_t text_find_prev(Text*, size_t pos, const char *s);
/* same as above but limit searched range to the line containing pos */
VIX_INTERNAL size_t text_line_find_next(Text*, size_t pos, const char *s);
VIX_INTERNAL size_t text_line_find_prev(Text*, size_t pos, const char *s);
 ...
 *  prev    start              end
 */
VIX_INTERNAL size_t text_line_prev(Text*, size_t pos);
VIX_INTERNAL size_t text_line_begin(Text*, size_t pos);
VIX_INTERNAL size_t text_line_start(Text*, size_t pos);
VIX_INTERNAL size_t text_line_finish(Text*, size_t pos);
VIX_INTERNAL size_t text_line_end(Text*, size_t pos);
VIX_INTERNAL size_t text_line_next(Text*, size_t pos);
VIX_INTERNAL size_t text_line_offset(Text*, size_t pos, size_t off);
/* get grapheme count of the line upto `pos' */
VIX_INTERNAL int text_line_char_get(Text*, size_t pos);
/* get position of the `count' grapheme in the line containing `pos' */
VIX_INTERNAL size_t text_line_char_set(Text*, size_t pos, int count);
/* get display width of line upto `pos' */
VIX_INTERNAL int text_line_width_get(Text*, size_t pos);
/* get position of character being displayed at `width' in line containing `pos' */
VIX_INTERNAL size_t text_line_width_set(Text*, size_t pos, int width);
/* move to the next/previous grapheme on the same line */
VIX_INTERNAL size_t text_line_char_next(Text*, size_t pos);
VIX_INTERNAL size_t text_line_char_prev(Text*, size_t pos);
/* move to start of next/previous blank line */
VIX_INTERNAL size_t text_line_blank_next(Text*, size_t pos);
VIX_INTERNAL size_t text_line_blank_prev(Text*, size_t pos);
 ...
 */
VIX_INTERNAL size_t text_longword_end_next(Text*, size_t pos);
VIX_INTERNAL size_t text_longword_end_prev(Text*, size_t pos);
VIX_INTERNAL size_t text_longword_start_next(Text*, size_t pos);
VIX_INTERNAL size_t text_longword_start_prev(Text*, size_t pos);
/*
 ...
 */
VIX_INTERNAL size_t text_word_end_next(Text*, size_t pos);
VIX_INTERNAL size_t text_word_end_prev(Text*, size_t pos);
VIX_INTERNAL size_t text_word_start_next(Text*, size_t pos);
VIX_INTERNAL size_t text_word_start_prev(Text*, size_t pos);
/*
 * More general versions of the above, define your own word boundaries.
 */
VIX_INTERNAL size_t text_customword_start_next(Text*, size_t pos, int (*isboundary)(int));
VIX_INTERNAL size_t text_customword_start_prev(Text*, size_t pos, int (*isboundary)(int));
VIX_INTERNAL size_t text_customword_end_next(Text*, size_t pos, int (*isboundary)(int));
VIX_INTERNAL size_t text_customword_end_prev(Text*, size_t pos, int (*isboundary)(int));
 ...
 * boundary.
 */
VIX_INTERNAL size_t text_sentence_next(Text*, size_t pos);
VIX_INTERNAL size_t text_sentence_prev(Text*, size_t pos);
/* TODO: implement the following semantics
 ...
 */
VIX_INTERNAL size_t text_paragraph_next(Text*, size_t pos);
VIX_INTERNAL size_t text_paragraph_prev(Text*, size_t pos);
...
VIX_INTERNAL size_t text_search_forward(Text *txt, size_t pos, Regex *regex);
VIX_INTERNAL size_t text_search_backward(Text *txt, size_t pos, Regex *regex);

/* is c a special symbol delimiting a word? */
VIX_INTERNAL int is_word_boundary(int c);
