...
#define da_reserve(vix, da, n) \
  (da)->data = da_reserve_(vix, (da)->data, &(da)->capacity, (da)->count + n, sizeof(*(da)->data))

#define da_push(vix, da) \
...
static void *
da_reserve_(Vix *vix, void *data, VixDACount *capacity, VixDACount needed, size_t size)
{
