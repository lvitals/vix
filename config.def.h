/* Vix configuration template. Copy to config.h and customize. */

/* Keybinding aliases and actions */
#define ALIAS(name) .alias = name,
#define ACTION(id) .action = &vix_action[VIX_ACTION_##id],

/* Keymaps for non-latin layouts (e.g. "bg-phonetic") */
static const char *keymaps[] = {
	NULL
};

/* General settings */
static const bool show_cursor_line = false;
static const bool show_line_numbers = false;

/* Theme to use by default */
#define THEME "default"

/* Basic keybindings (applied in all modes) */
...
static const KeyBinding bindings_operators[] = {
	...
	{ "8",                  ACTION(COUNT)                               },
	{ "9",                  ACTION(COUNT)                               },
	{ "=",                  ALIAS("<vix-prompt-show>|fmt<Enter>")       },
	...
	{ "g~",                 ALIAS("<vix-prompt-show>|tr '[:lower:][:upper:]' '[:upper:][:lower:]'<Enter>") },
	{ "gu",                 ALIAS("<vix-prompt-show>|awk '{printf \"%s\", tolower($0)}'<Enter>")},
	{ "gU",                 ALIAS("<vix-prompt-show>|awk '{printf \"%s\", toupper($0)}'<Enter>")},
	{ "p",                  ACTION(PUT_AFTER)                           },
	{ "P",                  ACTION(PUT_BEFORE)                          },
...
static const KeyBinding bindings_normal[] = {
	...
	{ "<F1>",               ALIAS("<vix-prompt-show>help<Enter>")       },
	...
	{ "ZQ",                 ALIAS("<vix-prompt-show>q!<Enter>")         },
	{ "zt",                 ACTION(WINDOW_REDRAW_TOP)                   },
	{ "zz",                 ACTION(WINDOW_REDRAW_CENTER)                },
	{ "ZZ",                 ALIAS("<vix-prompt-show>wq<Enter>")         },
	{ 0 /* empty last element, array terminator */                      },
};

static const KeyBinding bindings_vixual[] = {
	{ "A",                  ACTION(SELECTIONS_NEW_LINES_END)            },
	{ "@",                  ACTION(MACRO_REPLAY)                        },
	{ ":",                  ACTION(PROMPT_SHOW)                         },
	{ "-",                  ACTION(SELECTIONS_ROTATE_LEFT)              },
	{ "+",                  ACTION(SELECTIONS_ROTATE_RIGHT)             },
	{ "<",                  ALIAS("<vix-operator-shift-left>gv")        },
	{ ">",                  ALIAS("<vix-operator-shift-right>gv")       },
...
static const KeyBinding bindings_vixual_line[] = {
	{ "v",                  ACTION(MODE_VISUAL)                         },
...
static const KeyBinding bindings_insert[] = {
	{ "<C-d>",              ALIAS("<vix-operator-shift-left><vix-operator-shift-left>") },
	{ "<C-i>",              ALIAS("<Tab>")                              },
	{ "<C-j>",              ALIAS("<vix-insert-verbatim>u000a")         },
	{ "<C-m>",              ALIAS("<Enter>")                            },
	{ "<C-r>",              ACTION(INSERT_REGISTER)                     },
	{ "<C-t>",              ALIAS("<vix-operator-shift-right><vix-operator-shift-right>") },
...
static const KeyBinding bindings_window[] = {
	...
	{ "J",                  ACTION(WINDOW_NEXT_MAX)                     },
	{ "K",                  ACTION(WINDOW_PREV_MAX)                     },
	{ "H",                  ACTION(WINDOW_PREV_MAX)                     },
	{ "L",                  ACTION(WINDOW_NEXT_MAX)                     },
	{ "_",                  ACTION(WINDOW_MAXIMIZE)                     },
	{ "|",                  ACTION(WINDOW_MAXIMIZE)                     },
	{ "v",                  ACTION(WINDOW_LAYOUT_VERTICAL)              },
	{ "s",                  ACTION(WINDOW_LAYOUT_HORIZONTAL)            },
	{ "t",                  ACTION(TAB_VIEW_TOGGLE)                     },
...
static const KeyBinding **default_bindings[] = {
	[VIX_MODE_OPERATOR_PENDING] = (const KeyBinding*[]){
		bindings_operators,
	...
	[VIX_MODE_NORMAL] = (const KeyBinding*[]){
		bindings_normal,
		bindings_selections,
		bindings_operators,
		bindings_motions,
	...
	[VIX_MODE_VISUAL] = (const KeyBinding*[]){
		bindings_vixual,
		bindings_selections,
		bindings_textobjects,
		bindings_operators,
	...
	[VIX_MODE_VISUAL_LINE] = (const KeyBinding*[]){
		bindings_vixual_line,
		NULL,
	},
	[VIX_MODE_INSERT] = (const KeyBinding*[]){
		bindings_insert,
		bindings_readline,
		bindings_basic,
		NULL,
