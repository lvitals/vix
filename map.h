 ...
 * Otherwise ``NULL``.
 */
VIX_INTERNAL void *map_closest(const Map *map, const char *prefix);
/**
 ...
 */
VIX_INTERNAL bool map_put(Map *map, const char *key, const void *value);
/**
 ...
 */
VIX_INTERNAL void *map_delete(Map *map, const char *key);
/**
 * Copy all entries from ``src`` into ``dest``, overwrites existing entries in ``dest``.
 * @param dest The destination map.
 * @param src The source map.
 */
VIX_INTERNAL bool map_copy(Map *dest, Map *src);
/**
 ...
 */
VIX_INTERNAL void map_iterate(const Map *map, bool (*handle)(const char *key, void *value, void *data), const void *data);
/**
 ...
 * @endrst
 */
VIX_INTERNAL const Map *map_prefix(const Map *map, const char *prefix);
/**
 * Test whether the map is empty (contains no elements).
 * @param map The map to check.
 */
VIX_INTERNAL bool map_empty(const Map *map);
/**
 * Empty the map.
 * @param map The map to clear.
 */
VIX_INTERNAL void map_clear(Map *map);
/**
 * Release all memory associated with this map.
 * @param map The map to free.
 */
VIX_INTERNAL void map_free(Map *map);
